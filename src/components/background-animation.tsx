...
const icons = [
  ...
  () => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fillRule="evenodd" clipRule="evenodd" d="M16.129 3.326C16.483 2.57 16.05 1.63 15.222 1.252c-.827-.378-1.782.023-2.136.779l-6.324 13.56-3.32-3.32c-.585-.586-1.536-.586-2.121 0-.586.586-.586 1.536 0 2.121l4.465 4.465c.28.28.658.439 1.06.439.04 0 .08-.002.12-.006.46-.05.883-.28 1.183-.646l7.173-15.318z" fill="#092E20"/>
    </svg>
  ),
  // AWS
  () => (
